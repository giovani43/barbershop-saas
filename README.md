...
<!-- Header -->
<img src="https://capsule-render.vercel.app/api?type=venom&color=0d1117&height=200&section=header&text=giovani43&fontSize=50&fontColor=c9d1d9&animation=fadeIn&fontAlignY=40&desc=Construyendo%20la%20web%2C%20una%20línea%20de%20código%20a%20la%20vez.&descSize=14&descAlignY=60&descColor=8b949e" width="100%"/>
...
current_focus = {
    ...
    "backend":  ["Python"],
    "next":     ["React", "Node.js", "Git avanzado"],
}
```
...
|:---------|:------------|
| [`SUBLI.v3`](https://github.com/giovani43/SUBLI.v3) | Sitio web en HTML |
| [`BBC-completado`](https://github.com/giovani43/BBC-completado) | Clon de la página de BBC |
| [`Website-commerce`](https://github.com/giovani43/Website-commerce) | E-commerce en HTML |
| [`Ejemplogit`](https://github.com/giovani43/Ejemplogit) | Primeros pasos con Git |
